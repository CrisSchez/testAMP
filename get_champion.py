...
#data.loc[0].to_json()
example_model_input = {"shipmode":"Second Class","city":"Henderson","state":"Kentucky","postalcode":42420,"region":"South","productid":"FUR-BO-10001798","sales":261.96,"quantity":2,"profit":41.9136,"segment":"Consumer","loyaltycard":0,"avgmonthlycharges":2607.945586274,"category":"Furniture","subcategory":"Bookcases","ordermonth":10,"weekday":0,"day":31}
...
try:
    ...
    yaml_text = \
      ...
      metadata:                                  # this is a predefined key for additional metadata
        ...
        training_file: "get_champion.py"       # suggested use case: training file used
    """
