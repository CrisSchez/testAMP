...
script_descriptor = open("dataprep_past.py")
a_script = script_descriptor.read()
...
df['daysordertoship']=dfcurrent['daysordertoship']
...
for record in json.loads(df_sample_clean.to_json(orient='records')):
  ...
  no_churn_record.pop('daysordertoship')
  ...
  response_labels_sample.append(
    {
      ...
      "final_label":record["daysordertoship"],
      "response_label":response["response"]["prediction"]["probability"],
