...
example_input_viz= {"data": {"colnames": ["shipmode", "city", "state", "postalcode", "region", "productid","sales", "quantity", "profit", "segment", "loyaltycard","avgmonthlycharges", "category", "subcategory", "ordermonth", "weekday","day"],"coltypes": ["STRING", "STRING","STRING","STRING","STRING","STRING","FLOAT","INT","FLOAT","STRING","INT","FLOAT","STRING","STRING","INT","INT","INT"],"rows": [["Second Class", "Henderson", "Kentucky", "42420", "South","FUR-BO-10001798", "261.96", "2", "41.9136", "Consumer", "0","2607.9455862740483", "Furniture", "Bookcases", "11", "3", "10"],["Second Class", "Henderson", "Kentucky", "42420", "South","FUR-BO-10001798", "261.96", "2", "41.9136", "Consumer", "0","2607.9455862740483", "Furniture", "Bookcases", "11", "3", "10"]]}}
...
try:
    ...
    yaml_text = \
      ...
      metadata:                                  # this is a predefined key for additional metadata
        ...
        training_file: "get_champion_viz.py"       # suggested use case: training file used
    """
    ...
    build_model_params = {
      ...
      "targetFilePath": "model_serve_viz.py",
