...
#data.loc[0].to_json()
example_model_input = {"shipmode":"Second Class","city":"Henderson","state":"Kentucky","postalcode":42420,"region":"South","sales":261.96,"quantity":2,"profit":41.9136,"segment":"Consumer","loyaltycard":0,"avgmonthlycharges":2607.945586274,"category":"Furniture","subcategory":"Bookcases","ordermonth":10,"weekday":0,"day":31}
#example_input_viz= {"data": {"colnames": ["shipmode", "city", "state", "postalcode", "region", "productid","sales", "profit", "segment", "loyaltycard","avgmonthlycharges", "category", "subcategory", "ordermonth", "weekday","day"],"coltypes": ["STRING", "STRING","STRING","STRING","STRING","STRING","FLOAT","FLOAT","STRING","INT","FLOAT","STRING","STRING","INT","INT","INT"],"rows": [["Second Class", "Henderson", "Kentucky", "42420", "South","FUR-BO-10001798", "261.96",  "41.9136", "Consumer", "0","2607.9455862740483", "Furniture", "Bookcases", "11", "3", "10"],["Second Class", "Henderson", "Kentucky", "42420", "South","FUR-BO-10001798", "261.96", "41.9136", "Consumer", "0","2607.9455862740483", "Furniture", "Bookcases", "11", "3", "10"]]}}
example_input_viz= {"data": {"colnames": ["state", "productid","category", "subcategory", "ordermonth", "weekday","day","unitprice"],"coltypes": ["STRING", "STRING","STRING","STRING","INT","INT","INT","FLOAT"],"rows": [[ "Kentucky","FUR-BO-10001798", "Furniture", "Bookcases", "11", "3", "10",'130'],[ "Kentucky","FUR-BO-10001798", "Furniture", "Bookcases", "11", "3", "10",'130']]}}
...
try:
    ...
    yaml_text = \
      ...
      metadata:                                  # this is a predefined key for additional metadata
        ...
        training_file: "get_champion_stock_viz.py"       # suggested use case: training file used
    """
    ...
    build_model_params = {
      ...
      "targetFilePath": "model_serve_stock_viz.py",
