...
dftraindays['unitprice']=dftraindays['sales']/dftraindays['quantity']
df2 = dftraindays[['state','productid','category','subcategory','ordermonth','weekday','day','unitprice','quantity']].groupby(['state','productid','category','subcategory','ordermonth','weekday','day','unitprice']).sum()
dftraindays=df2.reset_index()


dftypes=["STRING","STRING","STRING","STRING","INT","INT","INT","FLOAT","INT"]